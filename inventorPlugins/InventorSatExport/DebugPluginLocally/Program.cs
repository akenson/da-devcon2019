...
namespace DebugPluginLocally
{
    class Program
    {
        ...
        private static void DebugSamplePlugin(InventorServer app)
        {
            ...
            string boxPath = System.IO.Path.Combine(projectdir, @"inputFiles\", "CNC_01.iam");

            string boxPathCopy = System.IO.Path.Combine(projectdir, @"inputFiles\", "CNC_01_COPY.iam");
            ...
            // create an instance of InventorSatExportPlugin
            InventorSatExportPlugin.SampleAutomation plugin = new InventorSatExportPlugin.SampleAutomation(app);
